			...
			<div className="page-wrap py-16 sm:py-20">
				<div className="mx-auto max-w-xl text-center">
					...
					<div className="mt-6 flex flex-col items-center gap-3 sm:mt-7">
						...
						<div className="inline-flex flex-wrap items-center justify-center gap-2 rounded-full border border-border/80 bg-card/35 px-3 py-2 text-sm">
							<a
								href="https://linkedin.com/in/kandharibhavya"
								target="_blank"
								rel="noopener noreferrer"
								className="inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 font-medium text-[var(--text-muted)] transition-colors hover:text-[var(--text-strong)]"
							>
