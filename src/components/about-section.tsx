				...
				<div>
					...
					<div className="mx-auto mt-6 max-w-2xl text-left">
						<p className="text-[15px] leading-relaxed text-foreground sm:text-base">
							...
							processing workflows, and event-driven integrations
							— the kind of infrastructure that production systems
							depend on every day.
						</p>
						<p className="mt-4 text-[15px] leading-relaxed text-foreground sm:text-base">
							...
							wiring up a data pipeline, or shipping an
							application end-to-end, I focus on clean
							architecture, reliable systems, and code that's
